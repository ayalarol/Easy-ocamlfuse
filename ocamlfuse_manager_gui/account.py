...
class AccountManager:
    ...
    def mostrar_guia_oauth(self):
        ...
        guia = _(
            ...
            "3. Selecciona 'Aplicación de escritorio' o 'Aplicación web' como tipo de aplicación.\n"
            "   - 'Aplicación de escritorio' es la opción recomendada.\n"
            "4. Ponle un nombre (ejemplo: EasyOcamlfuse).\n"
            "5. Si eliges 'Aplicación web', agrega esta URI de redireccionamiento:\n"
            "    {redirect_uri}\n"
            "6. Haz clic en 'Crear' y descarga el archivo JSON.\n\n"
            "--- SOLUCIÓN AL ERROR 403 'ACCESS BLOCKED' ---\n"
            "Si al autorizar recibes el error 'Access blocked: ... has not completed the Google verification process':\n"
            "1. Ve a 'Pantalla de consentimiento de OAuth' en Google Cloud Console.\n"
            "2. Si el 'Estado de publicación' es 'En pruebas' (Testing), DEBES añadir tu email en la lista de 'Usuarios de prueba' (Test users).\n"
            "3. Haz clic en '+ ADD USERS' y escribe tu correo de Gmail.\n"
            "4. Guarda los cambios y vuelve a intentar la autorización en EasyOcamlfuse.\n\n"
